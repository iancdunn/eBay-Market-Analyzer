...
git clone https://github.com/yourusername/ebay-market-scraper.git
...
Enter the item name when prompted (e.g., Sony WH-1000XM4).
...
==============================
CSV Output (item_sales.csv): | Price | Date Sold | |-------|-----------| | 185.00| 2023-10-25| | 190.50| 2023-10-24| | ... | ... |
